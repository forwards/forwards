...
The **forwards** package provides anonymized data from surveys conducted by [Forwards](http://forwards.github.io/), the R Foundation taskforce on women and other under-represented groups.
...
The package currently contains a single dataset, `useR2016`, with anonymized results from a survey of participants at the [useR! 2016](http://user2016.org/) conference. The questions and form of responses are described in the help file (`?useR2016`).
